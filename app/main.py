...
app = FastAPI(title="Atlas Identity API", version="1.0.0", lifespan=lifespan)
...
async def validation_error_handler(request: Request, exc: RequestValidationError) -> JSONResponse:
    ...
    return error_response(
        request, 422, "IDENTITY_VALIDATION_ERROR", "Request validation failed.", details
    )


@app.get("/api/v1/identity/healthz", tags=["Health"])
